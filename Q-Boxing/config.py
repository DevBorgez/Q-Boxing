...
class CFG:
    ...
    ACTIONS: tuple[str, ...] = (
        ...
        "punch_short", "punch_medium", "punch_long",
        "dodge", "do_nothing"
    )
    ...
    # GLOVES
    # =========================
    # Evaluated in the creation of CFG (after load_dotenv() in main)
    ...
    # PNG points ↓, so when looking ↓ (facing=+90°), rotation should be 0
